...
## Phase 2: Brain (Logic & State Management)
- [ ] Implement Hierarchy Level Transition Logic (Levels 1-5) §5
- [ ] Implement Sector Lifecycle (Create, Clone, Close, Freeze) §6.5
- [ ] Implement Persistent Command Dispatcher (ls/cd Sniffing) §28.1
- [ ] Implement Directory Mode Overlay Logic (Local FS) §27.3
- [ ] Implement Activity Mode Overlay Logic (Process Tracking) §7.3
- [ ] Implement Global Search Logic §7.3

## Phase 3: Shell API & Enhanced Integration
- [ ] Implement CWD Tracking (OSC 9003) §27
- [ ] Implement Command Result Reporting (OSC 9002) §27.1
- [ ] Implement Directory Listing IPC (OSC 9001) §27
- [ ] Implement Remote Session Management (Disconnection Banner/Auto-close) §27.3
- [ ] Implement Shell Integration Script Generation (Fish/Bash/Zsh) §18.7

## Phase 4: Face (UI & Presentation Layer)
...
## Phase 5: Security & Modular Runtime
...
## Phase 7: Platform & Remote Support
